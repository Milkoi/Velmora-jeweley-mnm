...
|------------|----------------|-------------------|
| Lê Minh Quân | Trưởng nhóm | Phân tích hệ thống, Cấu hình WooCommerce, Thiết kế Database, Setup WordPress, Thiết kế UI/UX bằng Elementor, Quản lý Git, Nhập liệu và quản lý sản phẩm. |
| Trần Minh Nguyệt | Thành viên | Thiết kế UI/UX bằng Elementor, Tùy biến giao diện, Viết nội dung tin tức, SEO, Tối ưu tốc độ website, Cấu hình bộ lọc sản phẩm, Bảo mật & Backup. |
| Trần Quỳnh Anh | Thành viên | Cấu hình thanh toán (PayOS, VietQR), Cài đặt Form liên hệ, Hỗ trợ viết báo cáo & tài liệu, Kiểm thử tính tương thích di động. |
...
> **LƯU Ý QUAN TRỌNG:** Hiện tại, tệp cơ sở dữ liệu (.sql) chứa một số mã bảo mật nên đã bị hệ thống Git chặn không cho phép đẩy push lên kho lưu trữ trực tuyến. Do đó, việc chạy project trên môi trường Local sẽ gặp khó khăn nếu thiếu tệp này.
> 
> Quý thầy cô và người xem vui lòng ưu tiên kiểm tra hệ thống thông qua **Link Online (mục 10)** hoặc xem video demo chi tiết để đánh giá đầy đủ các tính năng của nhóm.
...
|Khách hàng  |lime2005  | TranNguyet@123 |
## 8. Hình ảnh minh họa hệ thống
Dưới đây là một số hình ảnh thực tế của giao diện website Velmora Jewelry:

- Trang Đăng nhập & Đăng ký (Login & Register): Giao diện cho phép người dùng đăng nhập hoặc đăng ký tài khoản để quản lý đơn hàng.
  ![Giao diện Đăng nhập](jewelry_images/DN.jpg)
...
- Trang Giới thiệu (About Us): Giới thiệu về câu chuyện thương hiệu và sứ mệnh của Velmora Jewelry.

  ![Giao diện Trang giới thiệu](jewelry_images/GT.png)

- Trang Tin tức (News): Nơi chia sẻ các kiến thức về trang sức, xu hướng thời trang và các chương trình khuyến mãi.

  ![Giao diện Trang tin tức](jewelry_images/TrangTT.png)

- Trang Liên hệ (Contact Us): Thông tin liên hệ, bản đồ và form gửi tin nhắn cho cửa hàng.

  ![Giao diện Trang liên hệ](jewelry_images/lienhe.png)

---

## 9. Video Demo hệ thống
Video hướng dẫn sử dụng và trải nghiệm các tính năng của hệ thống tại đây:
- **Link Video:** [Xem Video Demo tại đây](https://www.youtube.com/watch?v=vZGg50uOviY)

---

## 10. Link online đã deploy
Dự án hiện tại đã được triển khai trực tuyến tại:
- **Link Website:** [http://velmorahouse.byethost17.com/]
